...
namespace memory
{
    ...
    struct signature_hasher
    {
        ...
        template <const signature& sig>
        static constexpr uint32_t compute_hash(uint32_t hash) noexcept
        {
        ...
        template <const signature& sig, const signature&... rest_sigs>
        static constexpr uint32_t add(uint32_t hash = FNV_OFFSET_32) noexcept
        {
    ...
    template<const signature&... args>
    constexpr auto make_batch(uint32_t hash = signature_hasher::FNV_OFFSET_32)
    {
